...
class UnitFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'status' => fake()->randomElement(["Paid","Pending","Vacant"]),
            'unit_type' => fake()->randomElement(["1bhk","2bhk","3bhk","studio","penthouse","other"]),
            'resident_name' => fake()->word(),
            'resident_phone' => fake()->word(),
